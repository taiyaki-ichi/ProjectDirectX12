...
#define THROW_PDX12_EXCEPTION(s)	throw_exception(__FILE__,__LINE__,__func__,s);
	...
	//視錐台の8頂点の導出
	inline void get_frustum_vertex(XMFLOAT3 const& eye,float asspect, float nearZ, float farZ, float viewAngle, XMFLOAT3 const& cameraForward, XMFLOAT3 const& cameraRight, std::array<XMFLOAT3, 8>& result)
	{
		XMVECTOR tmpResult{};
